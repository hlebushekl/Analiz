...
namespace Analytics.Property
{
    public class DataYear
    {
        ...
        public static int YearSerchProductA() 
        {
            ...
            for (int i = 0; DataSerch.LenghtYear(2025) > i; i++) 
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
        public static int YearSerchProductB()
        {
            ...
            DataTable dataTable = DataSerch.Year(Years);
            for (int i = 0; DataSerch.LenghtYear(2025) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[5][i]);
            return result;
        }
    }
    public class DataMonths
    {
        public static int JanuaryProductA()
        {
            ...
            for (int i = 1; DataSerch.Lenght(1) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
        ...
        public static int FebruaryProductA()
        {
            ...
            for (int i = 1; DataSerch.Lenght(2) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
        ...
        public static int MarchProductA()
        {
            ...
            for (int i = 1; DataSerch.Lenght(3) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
        ...
        public static int AprilProductA()
        {
            ...
            for (int i = 1; DataSerch.Lenght(4) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
        ...
        public static int MayProductA()
        {
            ...
            for (int i = 1; DataSerch.Lenght(5) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
        ...
        public static int JuneProductA()
        {
            ...
            for (int i = 1; DataSerch.Lenght(6) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
        ...
        public static int JulyProductA()
        {
            ...
            for (int i = 1; DataSerch.Lenght(7) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[5][i]);
            return result;
        }
        ...
        public static int AugustProductA()
        {
            int result = 0;
            DataTable dataTable = DataSerch.Months(8);
            for (int i = 1; DataSerch.Lenght(8) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[5][i]);
            return result;
        }
        ...
        public static int SeptemberProductA()
        {
            int result = 0;
            DataTable dataTable = DataSerch.Months(9);
            for (int i = 1; DataSerch.Lenght(9) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
        ...
        public static int OctoberProductA()
        {
            ...
            for (int i = 1; DataSerch.Lenght(10) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
        ...
        public static int NovemberProductA()
        {
            ...
            for (int i = 1; DataSerch.Lenght(11) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
        ...
        public static int DecemberProductA()
        {
            ...
            for (int i = 1; DataSerch.Lenght(12) > i; i++)
                result += Convert.ToInt32(dataTable.Rows[4][i]);
            return result;
        }
